...
function CertificateLightboxModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Modal Header Bar */}
        <div className="flex items-center justify-between gap-3 px-5 py-3.5 sm:px-6 sm:py-4 border-b border-light-border dark:border-dark-border/80 bg-light-bg/95 dark:bg-slate-900/95">
        ...
        <div className="relative grow w-full bg-slate-100 dark:bg-slate-950 flex items-center justify-center overflow-hidden p-3 sm:p-5 min-h-85 sm:min-h-125">
