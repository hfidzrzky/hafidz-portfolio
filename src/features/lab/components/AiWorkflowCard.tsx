  ...
  return (
    <FadeIn delay={0.2} direction="up">
      <div className="bg-light-surface dark:bg-dark-surface border border-light-border dark:border-dark-border p-6 md:p-8 rounded-lg hover-glow transition-all duration-300 relative overflow-hidden mb-20 group shadow-sm">
        <div className="absolute right-0 top-0 w-64 h-64 bg-accent/4 dark:bg-accent/3 rounded-full blur-3xl pointer-events-none group-hover:bg-accent/8 dark:group-hover:bg-accent/6 transition-colors duration-500 -translate-y-1/2 translate-x-1/3"></div>
