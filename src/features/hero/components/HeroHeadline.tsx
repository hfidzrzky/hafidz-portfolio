...
export function HeroHeadline({ line1, line2, tape }: HeroHeadlineProps) {
  return (
    <h1 className="font-sans text-[38px] sm:text-[56px] md:text-[72px] lg:text-[82px] leading-[0.95] md:leading-[0.9] font-bold tracking-tight uppercase text-slate-800 dark:text-white">
      {line1}<br />
      {line2}<br />
