...
export function SectionIndicator({
  ...
  return (
    <div
      className={cn(
        'hidden md:flex flex-col items-center absolute left-0 md:left-[12px] top-0 h-full z-0',
        className
      )}
    >
      {showTopLine && (
        <div className="w-[1px] h-24 bg-light-border dark:bg-dark-border mb-4" />
      )}
      {showDots && (
      ...
      {showLine && (
        <div
          className={cn(
            'w-[1px] bg-light-border dark:bg-dark-border mt-3',
