...
export function JourneyEndNode({ statusText }: JourneyEndNodeProps) {
  return (
    <FadeIn delay={0.3} direction="up" className="relative flex flex-col md:flex-row mt-12 group">
      ...
      <div className="absolute left-3.75 md:left-40 top-7.5 h-16 w-px bg-linear-to-b from-light-border dark:from-dark-border to-transparent -translate-x-1/2" />

      {/* Pulsing End Node */}
      <div className="absolute left-3.75 md:left-40 top-4 w-2 h-2 -translate-x-1/2 flex justify-center items-center">
